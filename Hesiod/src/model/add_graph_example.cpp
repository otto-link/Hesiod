                                  ...
                                  std::string            category)
{
  ...
  //
           ...
           node_type == "PathDecasteljau" || node_type == "PathBezierRound" ||
           node_type == "PathFractalize" || node_type == "PathToHeightmap" ||
           node_type == "PathSDF" || node_type == "Ridgelines" ||
           node_type == "ReverseMidpoint" || node_type == "PathToCloud" ||
           node_type == "PathMeanderize")
  {
