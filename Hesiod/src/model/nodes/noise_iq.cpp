...
NoiseIq::NoiseIq(const ModelConfig *p_config) : BaseNode(p_config)
{
  LOG->trace("NoiseIq::NoiseIq");
  ...
  // documentation
  this->description = "NoiseIq, variant of NoiseFbm.";
  ...
  this->attribute_descriptions["gradient_scale"] = "Gradient influence scaling.";
}

std::shared_ptr<QtNodes::NodeData> NoiseIq::outData(QtNodes::PortIndex /* port_index */)
{
  return std::static_pointer_cast<QtNodes::NodeData>(this->out);
}

void NoiseIq::setInData(std::shared_ptr<QtNodes::NodeData> data,
