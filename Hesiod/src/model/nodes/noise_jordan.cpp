...
{
  LOG->trace("NoiseJordan::NoiseJordan");
  ...
  // documentation
  this->description = "NoiseJordan, variant of NoiseFbm.";
  ...
  this->attribute_descriptions["warp0"] = "Warping initial value.";
  this->attribute_descriptions["damp0"] = "Damping initial value.";
  this->attribute_descriptions["warp_scale"] = "Warping influence scaling.";
  this->attribute_descriptions["damp_scale"] = "Damping influence scaling.";
}
