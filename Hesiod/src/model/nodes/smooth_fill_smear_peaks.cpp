...
SmoothFillSmearPeaks::SmoothFillSmearPeaks(const ModelConfig *p_config)
    : BaseNode(p_config)
{
  LOG->trace("SmoothFillSmearPeaks::SmoothFillSmearPeaks");

  // model
  this->node_caption = "SmoothFillSmearPeaks";
  ...
  // documentation
  this->description = "SmoothFillSmearPeaks is a smoothing technique that restricts "
                      "smoothing "
                      "effect to concave regions.";
...
std::shared_ptr<QtNodes::NodeData> SmoothFillSmearPeaks::outData(
    QtNodes::PortIndex /* port_index */)
{
  return std::static_pointer_cast<QtNodes::NodeData>(this->out);
}

void SmoothFillSmearPeaks::setInData(std::shared_ptr<QtNodes::NodeData> data,
                                     QtNodes::PortIndex                 port_index)
{
  if (!data)
...
void SmoothFillSmearPeaks::compute()
{
