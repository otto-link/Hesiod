                                          ...
                                          std::weak_ptr<GraphConfig> config)
{
  ...
  // {
  //   auto sptr = std::make_shared<hesiod<hesiod::BroadcastNode>(node_type, config);
  ...
  switch (str2int(node_type.c_str()))
  {
    ...
    // SETUP_NODE(CloudSetValuesFromBorderDistance,
    // cloud_set_values_from_border_distance); SETUP_NODE(CloudSetValuesFromHeightmap,
    // cloud_set_values_from_heightmap); SETUP_NODE(CloudSetValuesFromMinDistance,
    // cloud_set_values_from_min_distance); SETUP_NODE(CloudShuffle, cloud_shuffle);
