...
WaveSquare::WaveSquare(const ModelConfig *p_config) : BaseNode(p_config)
{
  LOG->trace("WaveSquare::WaveSquare");

  // model
  this->node_caption = "WaveSquare";
  ...
  // documentation
  this->description = "WaveSquare generates square waves.";

  this->input_descriptions = {
      "Displacement with respect to the domain size (normal direction)."};
  this->output_descriptions = {"WaveSquare heightmap."};
...
std::shared_ptr<QtNodes::NodeData> WaveSquare::outData(
    QtNodes::PortIndex /* port_index */)
{
  return std::static_pointer_cast<QtNodes::NodeData>(this->out);
}

void WaveSquare::setInData(std::shared_ptr<QtNodes::NodeData> data,
                           QtNodes::PortIndex /* port_index */)
{
  if (!data)
  {
