...
Smoothstep5::Smoothstep5(const ModelConfig *p_config) : BaseNode(p_config)
{
  LOG_DEBUG("Smoothstep5::Smoothstep5");

  // model
  this->node_caption = "Smoothstep5";
...
std::shared_ptr<QtNodes::NodeData> Smoothstep5::outData(
    QtNodes::PortIndex /* port_index */)
{
  return std::static_pointer_cast<QtNodes::NodeData>(this->out);
}

void Smoothstep5::setInData(std::shared_ptr<QtNodes::NodeData> data,
                            QtNodes::PortIndex /* port_index */)
{
  if (!data)
