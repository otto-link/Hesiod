...
void setup_mountain_stump_node(BaseNode *p_node)
{
  ...
  ADD_ATTR(FloatAttribute, "ridge_amp", 0.75f, 0.f, FLT_MAX);
  ADD_ATTR(SeedAttribute, "seed");
  ADD_ATTR(IntAttribute, "octaves", 8, 0, 32);
  ADD_ATTR(FloatAttribute, "peak_kw", 6.f, 0.01f, FLT_MAX);
  ...
  ADD_ATTR(FloatAttribute, "gamma", 0.25f, 0.01f, 4.f);
  ADD_ATTR(BoolAttribute, "add_deposition", false);
...
void compute_mountain_stump_node(BaseNode *p_node)
{
  ...
  hmap::transform(
               ...
               hmap::Vec4<float>          bbox)
      {
        ...
        *pa_out = hmap::gpu::mountain_stump(shape,
