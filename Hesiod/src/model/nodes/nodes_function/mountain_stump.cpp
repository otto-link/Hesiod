...
void setup_mountain_stump_node(BaseNode &node)
{
  ...
  ADD_ATTR(node, FloatAttribute, "ridge_amp", 0.75f, 0.f, FLT_MAX);
  ADD_ATTR(node, SeedAttribute, "seed");
  ADD_ATTR(node, IntAttribute, "octaves", 8, 0, 32);
  ADD_ATTR(node, FloatAttribute, "peak_kw", 6.f, 0.01f, FLT_MAX);
  ...
  ADD_ATTR(node, FloatAttribute, "gamma", 0.25f, 0.01f, 4.f);
  ADD_ATTR(node, BoolAttribute, "add_deposition", false);
