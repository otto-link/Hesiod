...
void setup_polygon_field_fbm_node(BaseNode *p_node)
{
  ...
  ADD_ATTR(FloatAttribute, "clamping_dist", 0.1f, 0.f, FLT_MAX);
  ADD_ATTR(FloatAttribute, "clamping_k", 0.01f, 0.f, 0.2f);
  ADD_ATTR(FloatAttribute, "shift", 0.1f, 0.f, 1.f);
  ADD_ATTR(IntAttribute, "n_vertices_min", 3, 3, 64);
  ADD_ATTR(IntAttribute, "n_vertices_max", 8, 3, 64);
...
void compute_polygon_field_fbm_node(BaseNode *p_node)
{
  ...
  hmap::transform(
               ...
               hmap::Vec4<float>          bbox)
      {
        ...
        *pa_out = hmap::gpu::polygon_field_fbm(shape,
                                               ...
                                               GET("clamping_dist", FloatAttribute),
                                               GET("clamping_k", FloatAttribute),
                                               GET("n_vertices_min", IntAttribute),
                                               GET("n_vertices_max", IntAttribute),
