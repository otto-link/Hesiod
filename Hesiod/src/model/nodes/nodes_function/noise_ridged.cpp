...
void setup_noise_ridged_node(BaseNode *p_node)
{
  ...
  p_node->add_attr<FloatAttribute>("k_smoothing", 0.2f, 0.f, 1.f, "k_smoothing");
...
void compute_noise_ridged_node(BaseNode *p_node)
{
