...
void setup_wavelet_noise_node(BaseNode *p_node)
{
  ...
  ADD_ATTR(FloatAttribute, "kw_multiplier", 2.f, 0.f, FLT_MAX);
  ADD_ATTR(FloatAttribute, "vorticity", 0.f, 0.f, 10.f);
  ADD_ATTR(FloatAttribute, "density", 1.f, 0.f, 1.f);
  ...
  // attribute(s) order
  p_node->set_attr_ordered_key({"_GROUPBOX_BEGIN_Frequency and Structure",
                                "kw",
                                "seed",
                                "density",
                                "_GROUPBOX_END_",
...
void compute_wavelet_noise_node(BaseNode *p_node)
{
  ...
  hmap::transform(
               ...
               hmap::Vec4<float>          bbox)
      {
        ...
        *pa_out = hmap::gpu::wavelet_noise(shape,
                                           ...
                                           GET("kw_multiplier", FloatAttribute),
                                           GET("vorticity", FloatAttribute),
