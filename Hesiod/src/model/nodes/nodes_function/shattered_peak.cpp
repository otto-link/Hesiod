...
void setup_shattered_peak_node(BaseNode &node)
{
  ...
  ADD_ATTR(node, FloatAttribute, "angle", 45.f, -180.f, 180.f, "{:.0f}°");
  ADD_ATTR(node, FloatAttribute, "gamma", 1.f, 0.01f, 4.f);
  ADD_ATTR(node, BoolAttribute, "add_deposition", true);
  ADD_ATTR(node, FloatAttribute, "bulk_amp", 0.25f, 0.f, 2.f);
  ADD_ATTR(node, FloatAttribute, "base_noise_amp", 0.15f, 0.f, 1.f);
