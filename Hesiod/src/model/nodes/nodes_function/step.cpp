...
void setup_step_node(BaseNode *p_node)
{
  ...
  p_node->add_attr<FloatAttribute>("slope", 2.f, 0.01f, 32.f, "slope");
  ...
  p_node->set_attr_ordered_key(
      {"angle", "slope", "center", "_SEPARATOR_", "inverse", "remap_range"});
}

void compute_step_node(BaseNode *p_node)
{
