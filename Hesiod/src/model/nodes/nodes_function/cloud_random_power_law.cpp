...
void setup_cloud_random_power_law_node(BaseNode *p_node)
{
  ...
  ADD_ATTR(FloatAttribute, "distance_max", 0.15f, 0.001f, 1.f);
  ADD_ATTR(FloatAttribute, "alpha", 0.5f, 0.01f, 4.f);
...
void compute_cloud_random_power_law_node(BaseNode *p_node)
{
  ...
  *p_out = hmap::random_cloud_distance_power_law(GET("distance_min", FloatAttribute),
