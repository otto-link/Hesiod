...
void setup_vorolines_node(BaseNode *p_node)
{
...
void compute_vorolines_node(BaseNode *p_node)
{
  ...
  hmap::transform(
               ...
               hmap::Vec4<float>          bbox)
      {
        ...
        *pa_out = hmap::gpu::vorolines(shape,
                                       ...
                                       M_PI / 180.f * GET("angle_span", FloatAttribute),
                                       rtype,
                                       pa_dx,
                                       pa_dy,
                                       bbox);
