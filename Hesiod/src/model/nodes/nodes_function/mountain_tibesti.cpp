...
void setup_mountain_tibesti_node(BaseNode *p_node)
{
  ...
  // attribute(s)
  ADD_ATTR(FloatAttribute, "elevation", 0.5f, 0.f, 1.f);
  ADD_ATTR(FloatAttribute, "scale", 1.f, 0.01f, FLT_MAX);
  ADD_ATTR(SeedAttribute, "seed");
  ADD_ATTR(IntAttribute, "octaves", 8, 0, 32);
  ADD_ATTR(FloatAttribute, "peak_kw", 22.f, 0.01f, FLT_MAX);
  ADD_ATTR(FloatAttribute, "rugosity", 0.f, 0.f, 1.f);
  ADD_ATTR(FloatAttribute, "angle", 30.f, -180.f, 180.f, "{:.0f}°");
  ADD_ATTR(FloatAttribute, "angle_spread_ratio", 0.25f, 0.f, 1.f);
  ADD_ATTR(FloatAttribute, "gamma", 1.5f, 0.01f, 4.f);
  ADD_ATTR(BoolAttribute, "add_deposition", true);
  ADD_ATTR(FloatAttribute, "bulk_amp", 0.5f, 0.f, 2.f);
...
void compute_mountain_tibesti_node(BaseNode *p_node)
{
  ...
  hmap::transform(
               ...
               hmap::Vec4<float>          bbox)
      {
        ...
        *pa_out = hmap::gpu::mountain_tibesti(shape,
