...
{
    #define SERIALIZATION_BATCH_IMPLEMENT_SERIALIZE_CASE(Enum, Cast)    case SerializationBatchHelperElementType::Enum: \
                                                                        { \
                                                                            batchData[e->name] = *reinterpret_cast< Cast *>(e->data); \
                                                                            break; \
                                                                        }

    #define SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(Enum, Cast) case SerializationBatchHelperElementType::Enum: \
                                                                        { \
    ...
    bool SerializationBatchHelper::serialize_json_v2(std::string fieldName, nlohmann::json& outputData)
    {
        ...
        for(SerializationBatchHelperElement* e : this->elements)
        {
            ...
            switch (e->type) {
                ...
                SERIALIZATION_BATCH_IMPLEMENT_SERIALIZE_CASE(UNSIGNED_SHORT, unsigned short);
                ...
                SERIALIZATION_BATCH_IMPLEMENT_SERIALIZE_CASE(UNSIGNED_LONG_LONG, unsigned long long);
                ...
                case SerializationBatchHelperElementType::OBJECT:
                {
                    ...
                    if(base) base->serialize_json_v2("sub", tempData);
    ...
    bool SerializationBatchHelper::deserialize_json_v2(std::string fieldName, nlohmann::json& inputData)
    {
        if(inputData[fieldName].is_null() || inputData[fieldName].is_object() == false)
        {
        ...
        {
            if(e->data == nullptr) continue;
            if(batchData[e->name].is_null()) continue;
            ...
            switch (e->type) 
            {
                ...
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(UNSIGNED_SHORT, unsigned short);
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(SHORT, short);
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(UNSIGNED_INT, unsigned int);
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(INT, int);
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(LONG_LONG, long long);
                SERIALIZATION_BATCH_IMPLEMENT_DESERIALIZE_CASE(UNSIGNED_LONG_LONG, unsigned long long);
                ...
                case SerializationBatchHelperElementType::OBJECT:
                {
                    ...
                    if(base) base->deserialize_json_v2("sub", tempData);
