...
ThermalFlatten::ThermalFlatten(std::string id) : ControlNode(id)
{
  this->node_type = "ThermalFlatten";
  this->category = category_mapping.at(this->node_type);

  this->attr["talus_global"] = NEW_ATTR_FLOAT(0.1f, 0.f, 10.f);
  this->attr["iterations"] = NEW_ATTR_INT(10, 1, 200);
...
void ThermalFlatten::update_inner_bindings()
{
