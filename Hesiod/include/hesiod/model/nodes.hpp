 ...
 * @brief Crater class.
 */
class Crater : public BaseNode
{
public:
  Crater(const ModelConfig *p_config);
...
/**
 * @brief DiffusionLimitedAggregation class.
 */
class DiffusionLimitedAggregation : public BaseNode
{
public:
  DiffusionLimitedAggregation(const ModelConfig *p_config);
...
/**
 * @brief HydraulicBlur class.
 */
class HydraulicBlur : public BaseNode
{
public:
  HydraulicBlur(const ModelConfig *p_config);
...
/**
 * @brief KernelGabor class.
 */
class KernelGabor : public BaseNode
{
public:
  KernelGabor(const ModelConfig *p_config);
...
protected:
  std::weak_ptr<HeightMapData>   dx, dy, ctrl, envelope;
  std::shared_ptr<HeightMapData> out;
};
...
/**
 * @brief PathDecasteljau class.
 */
class PathDecasteljau : public BaseNode
{
public:
  PathDecasteljau(const ModelConfig *p_config);
 ...
 * @brief Rift class.
 */
class Rift : public BaseNode
{
public:
  Rift(const ModelConfig *p_config);
 ...
 */
class Translate : public BaseNode
{
public:
  Translate(const ModelConfig *p_config);
...
protected:
  std::weak_ptr<HeightMapData>   in, dx, dy;
  std::shared_ptr<HeightMapData> out;
};
 ...
 * @brief Warp class.
 */
class Warp : public BaseNode
{
public:
  Warp(const ModelConfig *p_config);
...
/**
 * @brief WarpDownslope class.
 */
class WarpDownslope : public BaseNode
{
public:
  WarpDownslope(const ModelConfig *p_config);
 ...
 * @brief Zoom class.
 */
class Zoom : public BaseNode
{
public:
  Zoom(const ModelConfig *p_config);
