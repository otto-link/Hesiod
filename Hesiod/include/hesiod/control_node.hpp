...
class ExportAsset : virtual public ControlNode
{
public:
  ExportAsset(std::string id);
...
class RecastSag : virtual public ControlNode
{
public:
  RecastSag(std::string id);
