...
ErosionMaps::ErosionMaps(std::string id) : gnode::Node(id)
{
  ...
  this->add_port(gnode::Port("1 initial", gnode::direction::in, dtype::dHeightMap));

  this->add_port(gnode::Port("2 eroded", gnode::direction::in, dtype::dHeightMap));
