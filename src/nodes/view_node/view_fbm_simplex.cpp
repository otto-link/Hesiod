...
ViewFbmSimplex::ViewFbmSimplex(std::string     id,
                               hmap::Vec2<int> shape,
...
bool ViewFbmSimplex::render_settings()
{
...
void ViewFbmSimplex::serialize_save(cereal::JSONOutputArchive &ar)
{
...
void ViewFbmSimplex::serialize_load(cereal::JSONInputArchive &ar)
{
  ar(cereal::make_nvp("kw.x", this->kw.x));
  ar(cereal::make_nvp("kw.y", this->kw.y));
  ar(cereal::make_nvp("seed", this->seed));
